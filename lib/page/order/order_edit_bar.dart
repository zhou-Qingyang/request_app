...
class OrderEditAppbar extends StatelessWidget implements PreferredSizeWidget {
  final double _contentHeight = 44.h;
  final Widget title;
  final VoidCallback onAdd;

  OrderEditAppbar({Key? key, required this.title,required this.onAdd}) : super(key: key);
